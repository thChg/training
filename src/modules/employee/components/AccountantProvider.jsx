...
// import { exportAccountantToExcel } from "../functions/exportAccountantToExcel.js";

export const AccountantContext = React.createContext();

export class AccountantProvider extends Component {
  constructor(props) {
    super(props);
  ...
  async componentDidMount() {
    const { accountantList, fetchRecordList } = this.props;
  ...
  componentDidUpdate(prevProps) {
    if (prevProps.accountantList !== this.props.accountantList) {
      this.setState({
  ...
  async exportToExcel() {
    ...
    // await exportAccountantToExcel(data);
  }
...
export default connect(mapStateToProps, mapDispatchToProp)(AccountantProvider);
